...
class Experiment():
    ...
    def get_predictions(self):
        ...
        for batch in tqdm(range(int(self.data.num_batch_test))):
            ...
            for i, (q, h, t) in enumerate(zip(qq, hh, tt)):
                ...
                if self.option.adv_rank:
                    ...
                    eval_fn = lambda t: (t[1] > p_head) or (
                                (t[1] == p_head) and (t[0] != h) and (np.random.uniform() < 0.5))
                else:
                ...
                if self.option.query_is_language:
                    ...
                    to_write = [q_string, h_string, t_string] + this_predictions + ['#'] + eql_predictions + [
                        self.data.number_to_entity[h]]
        ...
        print("Eval result: Mrr: {}, Hit@1: {}, Hit@3: {}, Hit@10: {}, Count: {}".format(mrr, hit_1, hit_3, hit_10,
                                                                                         count))
